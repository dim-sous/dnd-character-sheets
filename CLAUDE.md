...
- The only two behaviors the app encodes (both hand-overridable): damage is taken from temp HP first then real HP and floors at 0; a long rest restores spell slots and nothing else.
